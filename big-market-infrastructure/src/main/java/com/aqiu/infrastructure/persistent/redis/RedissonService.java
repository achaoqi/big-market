package com.aqiu.infrastructure.persistent.redis;
...
public class RedissonService implements IRedisService {
    ...
    @Override
    public Boolean setNx(String key, long expireMills, TimeUnit timeUnit) {
        return redissonClient.getBucket(key).trySet("lock",expireMills,timeUnit);
    }
