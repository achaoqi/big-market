package com.aqiu.domain.credit.event;
...
public class CreditAdjustSuccessMessageEvent extends BaseEvent<CreditAdjustSuccessMessageEvent.CreditAdjustSuccessMessage>{
    ...
    @Override
    public BaseEvent.EventMessage<CreditAdjustSuccessMessageEvent.CreditAdjustSuccessMessage> buildEventMessage(CreditAdjustSuccessMessageEvent.CreditAdjustSuccessMessage data) {
